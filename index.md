...
<div style="float: right; display: flex; gap: 10px; margin-left: 20px; align-items: flex-start;">
  <a href="assets/images/ExecSummary.pdf">
    <img src="assets/images/ExecSummary.png"
         style="height: 250px !important; width: auto !important; display: block;" />
  </a>
...
**Francisca Ortiz Ruiz**, *Universidad Mayor*, Chile <br>
**Tubaro, Paola**, *Institut Polytechnique de Paris*, France <br>
**Molina, Jose Luis**, *Universitat Autònoma de Barcelona*, Spain <br>
**Neal, Jennifer Watling**, *Michigan State University*, USA  <br>
**Vacca, Raffaele**, *University of Milan*, Italy <br>
**Diesner, Jana**, *Technical University of Munich*, Germany <br>
